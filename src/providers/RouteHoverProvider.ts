...
const VerboseHover = (vscode as typeof vscode & {VerboseHover?: VerboseHoverConstructor}).VerboseHover ?? vscode.Hover
const supportsVerboseHover = VerboseHover !== vscode.Hover
...
export class RouteHoverProvider implements vscode.HoverProvider {
    ...
    async provideHover(
        ...
        // VerboseHover
        const markdown = new vscode.MarkdownString(!supportsVerboseHover || this.verbosity
            ? cardParts.join('\n\n')
            : 'Route metadata')
